            ...
            <section className="creatorshelf-dashboard-content-panel">
                ...
                <div className="creatorshelf-dashboard-account-row ">
                    ...
                    <div className="d-flex align-items-center gap-3">
                        <div className="creatorshelf-dashboard-account-device-icon d-flex align-items-center justify-content-center">
                            <Icons.Fingerprint size={20} />
                        </div>
                        <div>
                            <p className="creatorshelf-dashboard-profile-toggle-title mb-0">Two-Factor Authentication</p>
                            <p className="creatorshelf-dashboard-profile-toggle-desc mb-0">Secure your account with 2FA security.</p>
                        </div>
                    </div>

                    {/* Right Side: Toggle Switch */}
                    <div className="form-check form-switch creatorshelf-dashboard-notification-row mb-0">
