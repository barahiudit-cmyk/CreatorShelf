            ...
            <div className="creatorshelf-dashboard-analytics-tooltip">
                ...
                {payload.map((entry: any, index: number) => (
                    <div key={index} className="d-flex align-items-center gap-3 mb-1">
                        ...
                        <span className="extra-small fw-bold text-white ms-auto">
        ...
        >
            <div>
                ...
                <p className="creatorshelf-dashboard-overview-subtitle">
                    Track your growth and performance across all platforms.
                </p>
            </div>
    ...
    return (
        <div className="d-flex gap-3 mb-4 overflow-auto pb-2">
            {platformTabs.map((tab, index) => {
                ...
                return (
                    ...
                    >
                        ...
                        <div>
                            <p className="extra-small fw-bold mb-0">{tab.name}</p>
            ...
            >
                ...
                <span className="extra-small text-dim fw-bold">Add Platform</span>
            </motion.div>
        </div>
    );
};

export const GrowthChartCard = () => {
    return (
        <div className="creatorshelf-dashboard-analytics-panel">
            <div className="creatorshelf-dashboard-analytics-panel-header">
                ...
                <div className="creatorshelf-dashboard-analytics-btn-control py-1 px-2">
                    Last 30 Days <Icons.ChevronDown size={14} />
                </div>
            </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Line
                            ...
                            stroke="#ed4c37"
                            strokeWidth={3}
                            dot={{ r: 4, fill: '#ed4c37', strokeWidth: 0 }}
                            activeDot={{ r: 6 }}
                        />
                        <Line
                            type="monotone"
                            ...
                            stroke="#bc1888"
                            strokeWidth={3}
                            dot={{ r: 4, fill: '#bc1888', strokeWidth: 0 }}
                            activeDot={{ r: 6 }}
                        />
                    </LineChart>
                </ResponsiveContainer>
...
export const GrowthSummaryCard = () => {
    const summaryItems = [
        {
    ...
    return (
        <div className="creatorshelf-dashboard-analytics-panel">
            ...
            <div className="d-flex flex-column gap-4">
                {summaryItems.map((sum, i) => (
                    ...
                    >
                        <div>
                            ...
                            <h6 className="creatorshelf-dashboard-overview-subtitle mb-0">
                                {sum.val}{' '}
                                <span className="text-success-custom ms-1 small">
                                    {sum.growth}
                                </span>
                            </h6>
                        </div>
                ...
                <a
                    href="#"
                    className="text-purple extra-small fw-bold mt-2 text-decoration-none"
                >
    ...
    return (
        <div className="creatorshelf-dashboard-analytics-panel">
            <div className="creatorshelf-dashboard-analytics-panel-header">
                ...
                <div className="creatorshelf-dashboard-analytics-btn-control py-1 px-2">
                    By Engagement <Icons.ChevronDown size={14} />
                </div>
            </div>
            ...
            <div className="mt-2 creatorshelf-dashboard-analytics-container">
                {posts.map((post, i) => (
                    <motion.div
                        ...
                        key={i}
                        className="creatorshelf-dashboard-analytics-content-row"
                    >
                        <img
                            src={`https://placehold.co/100x70/0a0a0a/7c3aed?text=Vid+${i + 1}`}
                            className="creatorshelf-dashboard-analytics-thumb-img"
                            alt="thumb"
                        />
                        <div className="flex-grow-1 px-3">
                            <p className="extra-small fw-bold mb-0 text-truncate">
                                {post.title}
                            </p>
                            <p className="extra-small creatorshelf-dashboard-overview-subtitle mb-0">
                                {post.date}
                            </p>
                        </div>
                        ...
                        <div className="px-3 text-center">
                            ...
                            <p className="extra-small creatorshelf-dashboard-overview-subtitle fw-bold mb-0">
                                {post.eng}
                            </p>
                        </div>
                        <div className="ps-3 text-end">
                            <p className="extra-small text-dim mb-0">Rate</p>
                            <p className="extra-small fw-bold text-success-custom creatorshelf-dashboard-overview-subtitle mb-0">
                                {post.rate}
                            </p>
                        </div>
                    </motion.div>
            ...
            <a
                href="#"
                className="text-purple extra-small fw-bold mt-4 d-inline-block text-decoration-none"
            >
                View all content →
            </a>
        </div>
    ...
    return (
        <div className="creatorshelf-dashboard-analytics-panel">
            <div className="creatorshelf-dashboard-analytics-panel-header">
                ...
                <div className="creatorshelf-dashboard-analytics-btn-control py-1 px-2">
                    All Platforms <Icons.ChevronDown size={14} />
                </div>
            </div>
                    ...
                    {countries.map((country, i) => (
                        <div key={i} className="mb-3">
                            <div className="d-flex justify-content-between extra-small fw-bold mb-1 creatorshelf-dashboard-overview-subtitle">
                                ...
                                <span>{country.val}</span>
                            </div>
                            <div className="creatorshelf-dashboard-analytics-progress-track">
                                <div
                                    className="creatorshelf-dashboard-analytics-progress-bar"
                                    style={{ width: country.val }}
                                ></div>
                            </div>
                        </div>
                    ))}
                ...
                <div className="col-6 border-start border-secondary border-opacity-10">
                    ...
                    <div className="mt-2">
                        {AGE_DISTRIBUTION.map((d, i) => (
                            <div
                                key={i}
                                className="d-flex align-items-center gap-2 extra-small mb-1 creatorshelf-dashboard-overview-subtitle"
                            >
                                <div
                                    style={{
                                        width: 6,
                                ...
                                <span className="ms-auto fw-bold">{d.value}%</span>
                            </div>
                        ))}
                    </div>
                </div>
